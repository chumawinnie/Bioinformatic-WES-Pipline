...
def run_signature_extraction_and_comparison():
    # Directory paths
    vcf_dir = "/home/obiorach/test-work-sarek/9results-folder/variant_calling/mutect2/Tumour_vs_Normal/unzip_vcf"
    output_dir = "/home/obiorach/test-work-sarek/9results-folder/output-sig-result"
    specific_vcf_file = os.path.join(vcf_dir, "Tumour_vs_Normal.mutect2.vcf")

    # Create a temporary directory to process only the specific VCF file
    temp_vcf_dir = "/home/obiorach/test-work-sarek/4results-folder/variant_calling/mutect2/Tumour_vs_Normal/unzip_vcf/temp_vcf_dir"
...
if __name__ == "__main__":
    ...
    print("This script was created by Chuma Winner Obiora, a Bioinformatician")
